import{o,e as s,a1 as r,d as l,bx as i,i as m,g as a,a0 as p,A as g}from"./index-3ab894b1.js";const d={class:"markdown-body"},h=r(`<h2>Configuration</h2><p>Set the global config</p><pre><code class="language-shell">git config --global user.name &quot;[name]&quot;
...
</code></pre>`,27),_=[h],u={__name:"git-memo.content",setup(n,{expose:e}){return e({frontmatter:{}}),(c,b)=>(o(),s("div",d,_))}},f=l({__name:"git-memo",setup(n){p(t=>({"2f6ba480":a(e).cardColor}));const e=i();return(t,c)=>(o(),s("div",null,[m(a(u))]))}});const C=g(f,[["__scopeId","data-v-3f9f904a"]]);export{C as default};
